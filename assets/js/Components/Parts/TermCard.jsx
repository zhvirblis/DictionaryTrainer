        ...
        return (
            <div className={this.state.editing ? "card editing termcard" : "card termcard"} key={term.id}>
                <div className="card-body card-el">
                    ...
                    <p><input value={this.state.origin || ""} placeholder="Origin" onChange={this.originChange} /></p>
                    <h5 className="card-title">{term.transcription}</h5>
                    <p><input value={this.state.transcription || ""} placeholder="Transcription" onChange={this.transcriptionChange} /></p>
                    <h5 className="card-title">{term.translate}</h5>
                    <p><input value={this.state.translate || ""} placeholder="Translate" onChange={this.translateChange} /></p>
                    <h5 className="card-title">{term.helper}</h5>
                    <p><input value={this.state.helper || ""} placeholder="Helper" onChange={this.helperChange} /></p>
                    <p>
